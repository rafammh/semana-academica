...
export function Canvas(cardSA) {
    ...
    fotoUser.src = cardSA.fotoParticipante;
    ...
    function setText() {
        ...
        estilizaCategoria()
        ctx.fillText(cardSA.Categoria.nomeCategoria, cardSA.Categoria.eixoX, cardSA.Categoria.eixoY);
        estilizaNome()
        ctx.fillText(cardSA.nomeParticipante, 125, 140);
        estilizaDados()
        ctx.fillText(`${cardSA.pais}`, 125, 200);
        ctx.fillText(`${cardSA.cidade}`, 125, 220);
        ctx.fillText(`${cardSA.equipe}`, 125, 240);
        ctx.fillText(`${cardSA.equipe2}`, 125, 260);
